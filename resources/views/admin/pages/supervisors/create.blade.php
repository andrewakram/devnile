            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">
                            <a href="{{route('admin.supervisors')}}" class="text-muted text-hover-primary">
                                المشرفين</a>
                        </li>
                        <!--end::Item-->
                    </ul>
                        ...
                        <div class="card card-flush py-4" style="display: none">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select name="suspend" required class="form-select mb-2" data-control="select2"
                                        ...
                                        id="kt_ecommerce_add_product_status_select">
                                    <option></option>
                                    <option value="1">إيقاف</option>
                                    <option value="0" selected>إلغاء الإيقاف</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                            {{--                                <div class="text-muted fs-7">Set the product status.</div>--}}
...
{{--                        </ul>--}}
                        ...
                        <div class="d-flex justify-content-end">
                            <!--begin::Button-->
                            <a href="{{route('admin.supervisors')}}" id="kt_ecommerce_add_product_cancel"
