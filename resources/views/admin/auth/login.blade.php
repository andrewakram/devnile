...
{{--            </a>--}}
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-10 mx-auto">
                ...
                <!--begin::Heading-->
                    ...
                    <!--end::Link-->
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">تسجيل الدخول بلوحة التحكم الرئيسية</h1>
                        <!--end::Title-->
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{route('supervisor.login')}}" class="text-danger" target="_blank"> الذهاب الي لوحة تحكم المشرف</a>
                        <!--end::Submit button-->
                        <!--begin::Separator-->
