            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">
                        <a href="{{route('supervisor.home')}}" class="text-muted text-hover-primary">
                            الرئيسية
                        </a>
                        <!--begin::Separator-->
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class=" fs-3 fw-bold my-1 ms-1" style="color: #5482d5">الاقسام</small>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
                ...
                <div class="d-flex align-items-center py-1">
                    <!--begin::Wrapper-->
                    <!--begin::Button-->
                    <a href="{{route('supervisor.categories.create')}}" class="btn btn-sm btn-success"
                    ...
                    <div class="card-body pt-0">
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                            ...
                            <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class=" min-w-100px">الايقونة</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="delete_multi_form" method="post" action="{{route('supervisor.categories.deleteMulti')}}">
                        @csrf
                    ...
                    },
                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                        <tbody> ' +
                                '                                <tr>' +
                                '                                    <td style="text-align: center">  <p style="padding-right:150px">Devnile</p></td>' +
                                '                                    <td style="text-align: right"> <img src="{{asset('default.png')}}" width="150px" height="150px" /> </td>' +
                                '                                    <td style="text-align: right"><p>عنوان التقرير : الاقسام</p>' +
        ...
        $(document).on("click", ".delete", function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '{{route('supervisor.categories.delete')}}',
                        type: "post",
