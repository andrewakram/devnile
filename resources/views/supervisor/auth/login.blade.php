...
<head>
    ...
    <title>Devnile</title>
    <meta charset="utf-8"/>
    <meta name="description" content="Devnile"/>
    <meta name="keywords" content="Devnile"/>
    <meta name="viewport" content="width=device-width, initial-scale=1"/>
    <meta property="og:locale" content="en_US"/>
    <meta property="og:type" content="article"/>
    <meta property="og:title" content="Devnile"/>
...
{{--            </a>--}}
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-10 mx-auto">
                ...
                <!--begin::Form-->
                <form action="{{route('supervisor.login')}}" method="post" class="form w-100" id="kt_sign_in_form1">
                @csrf
                <!--begin::Heading-->
                    <div class="text-center mb-10">
                        <!--begin::Link-->
                    {{--                        <div class="text-gray-400 fw-bold fs-4">--}}
                    {{--                            <a href="" class=" fw-bolder" style="color: #5482d5">Devnile</a>--}}
                    {{--                        </div>--}}
                    {{--                        <br>--}}
                    <!--end::Link-->
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">تسجيل الدخول لوحة التحكم المشرف</h1>
                        <!--end::Title-->
                        @include('supervisor.includes.messages')
                    </div>
                    <!--begin::Heading-->
                    <!--begin::Input group-->
                    ...
                    <div class="text-center">
                        ...
                        <a href="{{route('admin.login')}}" class="text-warning" target="_blank"> الذهاب الي لوحة التحكم الرئيسية</a>
